...
create_clock -name CLK160 -period 6.25 -waveform { 0.00 3.125 } [get_ports clk_rx_in]
...
set_input_delay -add_delay -clock [get_clocks CLK160] -max 1.0 [get_ports {lvds_rx_in[0]}]
set_input_delay -add_delay -clock [get_clocks CLK160] -min 0.0 [get_ports {lvds_rx_in[0]}]

set_input_delay -add_delay -clock [get_clocks CLK10] -max  2.5 [get_ports {ENOUT_N[*]}]
set_input_delay -add_delay -clock [get_clocks CLK10] -min -2.5 [get_ports {ENOUT_N[*]}]

set_input_delay -add_delay -10 -clock [get_clocks CLK10] [get_ports {MACK[0]}]
set_input_delay -add_delay -20 -clock [get_clocks CLK10] [get_ports {MACK[1]}]
set_input_delay -add_delay -20 -clock [get_clocks CLK10] [get_ports {MACK[2]}]
set_input_delay -add_delay -10 -clock [get_clocks CLK10] [get_ports {MACK[3]}]

set_input_delay -add_delay -20 -clock [get_clocks CLK10] [get_ports {DATA_BUS_D1[*]}]
set_input_delay -add_delay -20 -clock [get_clocks CLK10] [get_ports {DATA_BUS_D2[*]}]
set_input_delay -add_delay -20 -clock [get_clocks CLK10] [get_ports {DATA_BUS_D3[*]}]
set_input_delay -add_delay -20 -clock [get_clocks CLK10] [get_ports {DATA_BUS_D4[*]}]
...
# For the moment CLR and RST of Dilogic are connected to common powerup ARST
# To do: create sync reset for CLK10
...
# SUB_COMP is in LVDS clock domain (40M). As it is constant level, no timing required.
...
set_output_delay -clock [get_clocks CLK10] -60 [get_ports {CLK_ADC_N[*]}]
...
set_output_delay -add_delay -clock [get_clocks CLK10] -max  2.5 [get_ports {T_H[*]}]
set_output_delay -add_delay -clock [get_clocks CLK10] -min -2.5 [get_ports {T_H[*]}]

# To do: measure proper delays
...
# Remove constraints, this is debug pin
...
set_clock_groups -asynchronous -group {CLK50} -group {CLK160}
set_clock_groups -asynchronous -group {CLK50} -group {CLK_REF}
set_clock_groups -asynchronous -group {CLK160} -group {CLK_REF}
...
set_false_path -from {altera_reserved_tck} -to {CLK160}
set_false_path -from {altera_reserved_tck} -to {CLK_REF}
set_false_path -from {CLK50} -to {altera_reserved_tck}
set_false_path -from {CLK160} -to {altera_reserved_tck}
...
# Temporary here
set_false_path -to [get_ports {DIL_RST[*]}]
set_false_path -to [get_ports {DIL_CLR[*]}]
set_false_path -to [get_ports {TEST_PIN}]
set_false_path -to  [get_ports {SUB_COMP[*]}]
