...
TOP_LEVEL_NAME="SerialFlashLoader"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/serial_flash_loader_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/altera_serial_flash_loader.v" -work serial_flash_loader_0 -cdslib ./cds_libs/serial_flash_loader_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SerialFlashLoader.vhd"                                                                                               
fi
